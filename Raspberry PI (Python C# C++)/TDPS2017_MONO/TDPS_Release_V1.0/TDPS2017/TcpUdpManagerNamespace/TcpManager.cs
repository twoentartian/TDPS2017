...
namespace TcpUdpManagerNamespace
{
	public sealed class TcpManager
	{
		...
		public ListenTaskDelegate TcpServerReceiveDelegate
		{
			get
			{
				return _tcpServerReceiveDelegate;
			}
		}
		...
		public ListenTaskDelegate TcpClientReceiveDelegate
		{
			get
			{
				return _tcpClientReceiveDelegate;
			}
		}
